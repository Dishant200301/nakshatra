...
───────────────────────────────────────────── */
const GALLERY = [
  { url: "/gallery/img1.png", big: true },
  { url: "/gallery/img2.png" },
  { url: "/gallery/img3.png" },
  { url: "/gallery/img4.png", big: true },
  { url: "/gallery/img5.png" },
  { url: "/gallery/img6.png", big: true },
  { url: "/gallery/img7.png" },
  { url: "/gallery/img8.png" },
  { url: "/gallery/img9.png" }
];
...
export default function NakshatraApp() {
  ...
  return (
    <div style={{
      ...
      {/* ── SATELLITE ── */}
      {satVisible && (
        <div className={`sat-panel ${satAnimate ? "sat-in" : "sat-out"}`} style={{ overflow: "hidden" }}>
          <iframe
            ...
            width="100%" style={{ border: 0, marginTop: "-70px", height: "calc(100% + 70px)" }} allowFullScreen loading="lazy" title="satellite" />
        </div>
      )}
